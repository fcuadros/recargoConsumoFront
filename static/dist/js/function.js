...
//   break; 
//  case 61:
//   $("#div-content").load('pages/riesgo-calcular_riesgo.html');
//   break; 
//  case 62:
//   $("#div-content").load('pages/riesgo-proyeccion_riesgo.html');
//   break; 
//  case 63:
//   $("#div-content").load('pages/riesgo-actualizar_riesgo.html');
//   break; 
//  case 64:
//   $("#div-content").load('pages/riesgo-actualizar_control.html');
//   break; 
//  case 65:
...
//   break;
  case 71:
  $("#div-content").load('pages/rc-distribucion-presupuesto-area.html');
   break;   
  case 72:
  $("#div-content").load('pages/rc-realizar-distribucion.html');
   break;
  case 73:
  $("#div-content").load('pages/rc-grafico-montos-tienda.html');
   break;
  case 74:
  $("#div-content").load('pages/rc-grafico-rc-area.html');
   break;   
  case 75:
  $("#div-content").load('pages/rc-grafico-rc-mes.html');
   break;   
  default: 
   $("#div-content").html('');
   break;     
